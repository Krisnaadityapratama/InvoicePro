                    ...
                    <div className="grid grid-cols-12 gap-4">
                      <div className="col-span-12 md:col-span-6">
                        <input
                          ...
                          className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 focus:border-brand-700 focus:outline-none"
                        />
                      </div>
                      <div className="col-span-6 md:col-span-2">
                        <input
                          ...
                          min="1"
                          className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-center focus:border-brand-700 focus:outline-none"
                        />
                      </div>
                      ...
                      <div className="col-span-12 md:col-span-1 flex items-center justify-center pt-1">
                        <button
                          type="button"
