              ...
              >
                <div className="md:col-span-4">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-200 bg-white text-black px-4 py-3 focus:outline-none focus:ring-2 focus:ring-black"
                  />
                </div>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
          ...
          <div className="mt-4 bg-green-50 rounded-2xl p-4 border border-green-200">
            <div className="flex justify-between items-center mb-2">
              <span className="font-medium text-green-800">💰 Keuntungan</span>
